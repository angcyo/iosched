...
import net.majorkernelpanic.streaming.RGLSurfaceView;
...
public abstract class VideoStream extends MediaStream {
	...
	protected RGLSurfaceView mSurfaceView = null;
	 ...
	 */
	public synchronized void setSurfaceView(RGLSurfaceView view) {
		mSurfaceView = view;
	...
	public synchronized void stop() {
		if (mCamera != null) {
			...
			if (mMode == MODE_MEDIACODEC_API_2) {
				((RGLSurfaceView)mSurfaceView).removeMediaCodecSurface();
			}
			super.stop();
	...
	protected void encodeWithMediaCodecMethod2() throws RuntimeException, IOException {
		...
		((RGLSurfaceView)mSurfaceView).addMediaCodecSurface(surface);
		mMediaCodec.start();
