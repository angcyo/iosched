...
import net.majorkernelpanic.streaming.gl.SurfaceManager;
import net.majorkernelpanic.streaming.gl.TextureManager;
...
/**
 * Created by robi on 2016-03-22 18:39.
 */
public class RGLSurfaceView extends CameraRecordGLSurfaceView implements Runnable{
    ...
    public void startGLThread() {
        ...
        if (mTextureManager.getSurfaceTexture() == null) {
            mThread = new Thread(RGLSurfaceView.this);
            mRunning = true;
            mThread.start();
